...
fn test_ns_file_level_basic() {
    let output = compile_and_run_eol("examples/test_ns_file_level_basic.cay")
        .expect("编译运行失败");
...
fn test_ns_block_level_basic() {
    let output = compile_and_run_eol("examples/test_ns_block_level_basic.cay")
        .expect("编译运行失败");
...
#[test]
fn test_ns_nested() {
    let output = compile_and_run_eol("examples/test_ns_nested.cay")
        .expect("编译运行失败");
...
fn test_ns_using_single() {
    let output = compile_and_run_eol("examples/test_ns_using_single.cay")
        .expect("编译运行失败");
...
fn test_ns_using_multiple() {
    let output = compile_and_run_eol("examples/test_ns_using_multiple.cay")
        .expect("编译运行失败");
...
fn test_ns_global_class_with_ns() {
    let output = compile_and_run_eol("examples/test_ns_global_class_with_ns.cay")
        .expect("编译运行失败");
...
fn test_ns_static_method() {
    let output = compile_and_run_eol("examples/test_ns_static_method.cay")
        .expect("编译运行失败");
...
fn test_ns_instance_method() {
    let output = compile_and_run_eol("examples/test_ns_instance_method.cay")
        .expect("编译运行失败");
...
fn test_ns_interface() {
    let output = compile_and_run_eol("examples/test_ns_interface.cay")
        .expect("编译运行失败");
...
fn test_ns_top_level_function() {
    let output = compile_and_run_eol("examples/test_ns_top_level_function.cay")
        .expect("编译运行失败");
...
fn test_ns_cross_namespace() {
    let output = compile_and_run_eol("examples/test_ns_cross_namespace.cay")
        .expect("编译运行失败");
...
fn test_ns_inheritance() {
    let output = compile_and_run_eol("examples/test_ns_inheritance.cay")
        .expect("编译运行失败");
...
fn test_ns_deep_nested() {
    let output = compile_and_run_eol("examples/test_ns_deep_nested.cay")
        .expect("编译运行失败");
...
fn test_ns_mixed_global_ns() {
    let output = compile_and_run_eol("examples/test_ns_mixed_global_ns.cay")
        .expect("编译运行失败");
...
fn test_ns_method_overload() {
    let output = compile_and_run_eol("examples/test_ns_method_overload.cay")
        .expect("编译运行失败");
...
fn test_ns_static_field() {
    let output = compile_and_run_eol("examples/test_ns_static_field.cay")
        .expect("编译运行失败");
...
fn test_ns_constructor_chain() {
    let output = compile_and_run_eol("examples/test_ns_constructor_chain.cay")
        .expect("编译运行失败");
...
fn test_ns_array_of_objects() {
    let output = compile_and_run_eol("examples/test_ns_array_of_objects.cay")
        .expect("编译运行失败");
...
fn test_ns_complex_scenario() {
    let output = compile_and_run_eol("examples/test_ns_complex_scenario.cay")
        .expect("编译运行失败");
...
fn test_ns_deep_edge_cases() {
    let output = compile_and_run_eol("examples/test_ns_deep_edge_cases.cay")
        .expect("编译运行失败");
...
fn test_ns_err_using_namespace_forbidden() {
    let err = compile_eol_expect_error("examples/test_ns_err_using_namespace.cay")
        .expect("应该编译失败");
    assert!(err.contains("不允许使用") || err.contains("using namespace") || err.contains("语法错误"));
}

#[test]
fn test_ns_err_using_wildcard_forbidden() {
    let err = compile_eol_expect_error("examples/test_ns_err_using_wildcard.cay")
        .expect("应该编译失败");
...
fn test_ns_err_duplicate_file_ns() {
    let err = compile_eol_expect_error("examples/test_ns_err_duplicate_file_ns.cay")
        .expect("应该编译失败");
    assert!(err.contains("只能出现一次") || err.contains("已经声明") || err.contains("重复") || err.contains("namespace"));
}
...
fn test_ns_err_class_not_imported() {
    let err = compile_eol_expect_error("examples/test_ns_err_class_not_imported.cay")
        .expect("应该编译失败");
    assert!(err.contains("未定义") || err.contains("找不到") || err.contains("不存在") || err.contains("NonExistentClass"));
}
...
fn test_ns_err_unclosed_block() {
    let err = compile_eol_expect_error("examples/test_ns_err_unclosed_block.cay")
        .expect("应该编译失败");
    assert!(err.contains("未闭合") || err.contains("期望") || err.contains("}") || err.contains("语法错误"));
}
